          ...
          <div class="profile-content">
              <div class="profile-header">
                  <div class="profile-main">
                      <img id="profile-image" src="./img/avatar_1.png" alt="Profile Picture">
                      <div class="profile-details">
                          <h1 id="profile-name">${userData.name}</h1>
                          <p id="profile-title">Senior Product Designer</p>
              ...
              <div class="content-row">
                  <div class="about-me">
                      <h2>About Me</h2>
                      <p id="about-me-text">Hi, I'm a final year student completing a bachelor's In information Technology in QUT, with experience. We are the company behind the wildly successful DIY channel 5-Minute Crafts, the inspirational and creative channel Bright Side.</p>
                  </div>
